import 'package:ecommerce_app_project_flutter/controller/auth/successresetpassword_controller.dart';
    ...
    return Scaffold(
      ...
      body: Container(
        ...
        child: Column(children: [
          ...
          const SizedBox(height: 50),
          Text("36".tr, style: Theme.of(context).textTheme.headline1!.copyWith(fontSize: 20)),
          const Spacer(),
